...
//        casas.add(new CardSorteReves("SORTE/REVÉS", 0));
        ...
        casas.add(new CardPropriedade("Av. Nossa Sra. de Copacabana", 60, 50, 50, new int[]{4, 20, 60, 180, 320, 450}));
        casas.add(new CardCompanhia("Companhia Ferroviária", 200, 50));
        casas.add(new CardPropriedade("Av. Brigadeiro Faria Lima", 240, 150, 150, new int[]{20, 100, 300, 750, 925, 1100}));
        casas.add(new CardCompanhia("Companhia de Viação", 200, 50));
...
//        casas.add(new CardSorteReves("SORTE/REVÉS", 0));
        ...
        casas.add(new CardPropriedade("Av. Pacaembu", 180, 100, 100, new int[]{14, 70, 200, 550, 750, 950}));
        casas.add(new CardCompanhia("Companhia de Táxi", 150, 40));
//        casas.add(new CardSorteReves("SORTE/REVÉS", 0));
...
//        casas.add(new CardSorteReves("SORTE/REVÉS", 0));
        ...
        casas.add(new CardCompanhia("Companhia de Navegação", 150, 40));
...
//        casas.add(new CardSorteReves("SORTE/REVÉS", 0));
        ...
        casas.add(new CardCompanhia("Companhia de Aviação", 200, 50));
        ...
        casas.add(new CardCompanhia("Companhia de Táxi Aéreo", 200, 50));
